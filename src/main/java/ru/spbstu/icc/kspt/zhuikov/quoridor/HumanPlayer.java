...
public class HumanPlayer extends Player {
    ...
    private int barriersNumber = 10; // todo убрать в конст.


    public HumanPlayer(QuoridorField field, PlayerPosition position, Owner owner) {
        this.marker = new Marker(position.initialVertical, position.initialHorizontal, owner);
        this.field = field;
    ...
    private void checkMarkerPlace(int vertical, int horizontal) throws FieldItemException {
